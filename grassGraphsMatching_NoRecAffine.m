function [corr,srcCorrInd, targCorrInd] = grassGraphsMatching_NoRecAffine...
                                    (X, Y, plotUVecs, p)
% corr = grassGraphsMatching_NoRecAffine(X, Y, plotUVecs, p)
...
LX = graphLaplacian_Clean_v2(UX, p);
LY = graphLaplacian_Clean_v2(UY, p);        
...
% correpondences.
[corr.X, corr.Y, srcCorrInd, targCorrInd]...
 = correspondenceData_Clean_v2(singCorrIndVecCell, totalScoreVec,...
      corrIndCell, X, Y, p); 
